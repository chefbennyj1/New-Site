...
//
        ...
        const storylineBubbleSpeechBubble4 = new SpeechBubble(page, {
            text: 'If there is even a chance we can use <br /> the defunct servers for one night<br/> of cyrpto mining<br/> its worth every second.',
            fill: 'rgba(255,255,255,0.6)',
            stroke: '#000',
            strokeWidth: 3,
            tailPosition: 'top-right', // You can expand _generatePathD to use this
        ...
        const storylineBubbleSpeechBubble5 = new SpeechBubble(page, {
            text: 'Well, alright then. Let\'s make a plan.',
            fill: 'rgba(255,255,255,0.6)',
            stroke: '#000',
            strokeWidth: 3,
